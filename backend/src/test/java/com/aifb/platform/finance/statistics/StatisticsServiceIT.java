...
class StatisticsServiceIT extends AbstractIntegrationTest {
    ...
    void summaryComputesIncomeExpenseNet() {
        ...
        SummaryResponse summary = service.summary(userId, null, null, Scope.PERSONAL);
    ...
    void byCategoryReturnsTotalsAndPercentages() {
        ...
        List<CategoryBreakdownResponse> breakdown =
                service.byCategory(userId, CategoryType.EXPENSE, null, null, Scope.PERSONAL);
    ...
    void trendGroupsByMonth() {
        ...
        List<TrendPointResponse> trend = service.trend(userId, null, null, Scope.PERSONAL);
